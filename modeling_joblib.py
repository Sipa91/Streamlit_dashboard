...
# 1. XGBoost Classifier on extracted text features
...
# 2. NLP Model: Logistic Regression

# Fit the TfidfVectorizer to the training data specifying a minimum document frequency of 3
